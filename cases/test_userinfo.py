    ...
    def test_userinfo(self, data):
        ...
        for key in data.keys():
            ...
            if flag:
                ...
                msg = ''
        if username1 in msg:
            print('test_userinfo:' + condition1[1:] + '=>' + username1[1:] + '====success', file=f)
        else:
            print('test_userinfo:' + condition1[1:] + '=>' + username1[1:] + '====fail', file=f)
        f.close()
        wd.quit()
...
if __name__ == '__main__':
    ...
    test_userinfo.test_userinfo('骑行状态：空闲，违约状态：无待处理违约，注册时间：2020-07-10 00:00:00,2020-07-11 00:00:00')
