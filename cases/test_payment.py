...
@ddt()
class Payment_TestCase(unittest.TestCase):
    datas = excel_read('D:\\testing\\util\\test_data.xlsx')
    paymentdatas = []
    for i in datas:
        if 'payment' in i[0]:
            paymentdatas.append(i)
    ...
    def test_payment(self, case):
            ...
            for key in data.keys():
                ...
                if condition == '用户姓名':
                    ...
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[1]/div[2]/div[2]/table/tbody/tr[1]/td[3]').click()
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[1]/div[2]/div[2]/table/tbody/tr[5]/td[5]').click()
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[1]/div[1]/div/input').send_keys(
                        19 * Keys.BACK_SPACE)
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[1]/div[1]/div/input').send_keys(starttime)
                    wd.find_element_by_xpath('/html/body/div[3]/div/div/div/div/div[1]/div[2]/div[1]/div/input').click()
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[2]/div[1]/div/input').send_keys(
                        19 * Keys.BACK_SPACE)
                    wd.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div/div/div[1]/div[2]/div[1]/div/input').send_keys(endtime)
                    wd.find_element_by_xpath('/html/body/div[3]/div/div/div/div/div[2]/div/a[2]').click()
                elif condition == '成功时间':
                    wd.find_element_by_id('fillAt').click()
                    starttime = query.split(',')[0]
                    ...
                    wd.find_element_by_xpath('/html/body/div[4]/div/div/div/div/div[2]/div/a[2]').click()
            wd.find_element_by_xpath(
                '//*[@id="root"]/div/div/div/section/section/div/main/div/div/div[2]/div/div/div/div/div/div/div[1]/form/div[3]/div/button[1]').click()
            time.sleep(0.5)
            try:
                wd.find_element_by_xpath(
                    '//*[@id="root"]/div/div/div/section/section/main/div/div/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[1]')
                Flag = True
            except:
                Flag = False
            if Flag:
                for key in data.keys():
                    ...
                    if condition == '用户姓名':
                        msg = msg + ';' + wd.find_element_by_xpath(
                            '//*[@id="root"]/div/div/div/section/section/main/div/div/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[1]').text
                    elif condition == '手机号码':
                        msg = msg + ';' + wd.find_element_by_xpath(
                            '//*[@id="root"]/div/div/div/section/section/main/div/div/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]').text
                    elif condition == '支付情况':
                        msg = msg + ';' + wd.find_element_by_xpath(
                            '//*[@id="root"]/div/div/div/section/section/main/div/div/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[5]/span').text
                    elif condition == '收费类型':
                        msg = msg + ';' + wd.find_element_by_xpath(
                            '//*[@id="root"]/div/div/div/section/section/main/div/div/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[6]/span/span[2]').text
                    elif condition == '发起时间':
        ...
        try:
            wd.find_element_by_xpath(
                '//*[@id="root"]/div/div/div/section/section/div/main/div/div/div[2]/div/div/div/div/div/div/div[1]/form/div[3]/div/button[2]').click()
        except:
            self.assertEqual(1, 2)
        self.wd = wd
        logoutput = LogOutput()
