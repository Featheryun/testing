...
class Test_payment:
    def test_payment(self, data):
        ...
        if Flag:
            ...
            msg = ''
        if query1 in msg:
            print('test_payment:' + condition1[1:] + ' ==> ' + query1[1:] + '===============>sucess', file=f)
        else:
            print('test_payment:' + condition1[1:] + ' ==> ' + query1[1:] + '===============>fail', file=f)


if __name__ == '__main__':
    test = Test_payment()
    test.test_payment('用户姓名：赵强，发起时间：2020-07-10 00:00:00,2020-07-17 00:00:00')
