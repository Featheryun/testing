...
class Test_shortorder:
    def test_shortorder(self, data):
        ...
        print(msg+'===============2')
        if quriy1 in msg:
            print('test_shortorder:'+condition1[1:]+'=>'+quriy1[1:]+'=========>sucess', file=f)
        else:
            print('test_shortorder:' + condition1[1:] + '=>' + quriy1[1:] + '=========>fail', file=f)
...
if __name__ == '__main__':
    ...
    test.test_shortorder('车辆编码：511502000458')
